...
(function (Sanscript) {
    ...
    var schemes = Sanscript.schemes = {
         ...
         */
        /*  brahmi: {
         vowels: '𑀅 𑀆 𑀇 𑀈 𑀉 𑀊 𑀋 𑀌 𑀍 𑀎 𑀏 𑀐 𑀑 𑀒 𑀓 𑀔'.split(' '),
         vowel_marks: '𑀸 𑀹 𑀺 𑀻 𑀼 𑀽 𑀾 𑀿 𑁀 𑁁 𑁂 𑁃 𑁄 𑁅'.split(' '),
         other_marks: '𑀁 𑀂 𑀀'.split(' '), 	
         virama: ['𑁆'],
         consonants: '𑀓 𑀔 𑀕 𑀖 𑀗 𑀘 𑀙 𑀚 𑀛 𑀜 𑀝 𑀞 𑀟 𑀠 𑀡 𑀢 𑀣 𑀤 𑀥 𑀦 𑀧 𑀨 𑀩 𑀪 𑀫 𑀬 𑀭 𑀮 𑀯 𑀰 𑀱 𑀲 𑀳 𑀴 𑀓𑁆𑀱𑁆 𑀚𑁆𑀜𑁆'.split(' '),
         symbols: '૦ ૧ ૨ ૩ ૪ ૫ ૬ ૭ ૮ ૯ ૐ ઽ ૤ ૥'.split(' '),
         candra: ['ૅ']
         }, */
        brahmi: {
            vowels: '𑀅 𑀆 𑀇 𑀈 𑀉 𑀊 𑀋 𑀌 𑀍 𑀎  𑀏 𑀐  𑀑 𑀒'.split(' '),
            vowel_marks: '𑀸 𑀺 𑀻 𑀼 𑀽 𑀾 𑀿 𑁀 𑁁  𑁂 𑁃  𑁄 𑁅'.split(' '),
            other_marks: '𑀁 𑀂 𑀀'.split(' '),
            virama: ['𑁆'],
            consonants: '𑀓 𑀔 𑀕 𑀖 𑀗 𑀘 𑀙 𑀚 𑀛 𑀜 𑀝 𑀞 𑀟 𑀠 𑀡 𑀢 𑀣 𑀤 𑀥 𑀦 𑀧 𑀨 𑀩 𑀪 𑀫 𑀬 𑀭 𑀮 𑀯 𑀰 𑀱 𑀲 𑀳 𑀴 𑀓𑁆𑀱 𑀚𑁆𑀜'.split(' '),
            symbols: '𑁦 𑁧 𑁨 𑁩 𑁪 𑁫 𑁬 𑁭 𑁮 𑁯 ૐ ઽ ૤ ૥'.split(' '),
            candra: ['ૅ']
        },
        /* Gujarati
         * --------
        ...
        burmese: {
//vowels: 'อ า ิ ี ุ ู ฤ ฤๅ ฦ ฦๅ  เ ไ  โ เ-า'.split(' '),
            vowels: 'อ ာ ิ ี ု ู ฤ ฤๅ ฦ ฦๅ  ေ ไ  ော เ-า'.split(' '),
            other_marks: ['ํ', 'ะ', 'ัํ'],
            virama: ['ฺ'],
            //consonants: 'ก ข ค ฆ ง จ ฉ ช ฌ ญ ฏ ฐ ฑ ฒ ณ ต ถ ท ธ น ป ผ พ ภ ม ย ร ล ว ศ ษ ส ห ฬ กษ ชญ'.split(' '),
            consonants: 'က ခ ဂ ဃ င စ ဆ ဇ ဈ ဉ ဋ ဌ ဍ ဎ ဏ တ ထ ဒ ဓ န ပ ဖ ဗ ဘ မ ယ ရ လ ဝ - - သ ဟ ဠ    '.split(' '),
        ...
        lao: {
        //vowels: 'อ า ิ ี ุ ู ฤ ฤๅ ฦ ฦๅ  เ ไ  โ เ-า'.split(' '),
        vowels: 'ອ າ ິ ີ ຸ ູ ຤ ຤າ ຦ ຦າ  ເ ໄ  ໂ ເ-ົາ'.split(' '),
                other_marks: ['ໍ', 'ະ', 'ั'], 
                virama: ['຺'],
                //consonants: 'ก ข ค ฆ ง จ ฉ ช ฌ ญ ฏ ฐ ฑ ฒ ณ ต ถ ท ธ น ป ผ พ ภ ม ย ร ล ว ศ ษ ส ห ฬ กษ ชญ'.split(' '),
                consonants: 'ກ ຂ ຄ ຆ ງ ຈ ຉ ຊ ຌ ຎ ຏ ຐ ຑ ຒ ຓ ຕ ຖ ທ ຘ ນ ປ ຜ ພ ຠ ມ ຍ ຣ ລ ວ ຨ ຩ ສ ຫ ຬ ກຩ ຊ຅'.split(' '),
